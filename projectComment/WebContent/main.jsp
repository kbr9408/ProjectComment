            ...
            <div class="inner">
              ...
              <nav>
                <ul class="nav masthead-nav">
                  ...
                  <li><a href="contact" data-hide=".cover-wrapper">Contact</a></li>
                </ul>
              </nav>
            </div>
          </div>
...
<!--           메인글
 -->            <h1 class="cover-heading">Comma Project</h1>
            ...
            <p><a href="contact" class="btn btn-lg btn-default" data-hide=".cover-wrapper">Join with us</a></p>
          </div>
              ...
              <div class="inner">
                ...
                <nav>
                  <ul class="nav masthead-nav">
                    ...
                    <li><a href="contact" data-hide="#blog">Contact</a></li>
                  </ul>
                </nav>
              </div>
      ...
      <div class="container">
        <div class="row">
          <div class="inner">
            ...
            <nav>
              <ul class="nav masthead-nav">
                <li><a href="index" data-hide="#contact">Home</a></li>
                <li><a href="blog" data-hide="#contact">Blog</a></li>
                <li><a href="projects" data-hide="#contact">Projects</a></li>
                    <li class="active"><a href="#" data-hide="#contact">Contact</a></li>
              </ul>
            </nav>
          </div>
        </div>
